...
import static com.obimon.obimon_mobile.MyTestService.latestFirmwareDate;
...
//                        }
    ...
    public class MyExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, final int childPosition,
            ...
            if(item.bat>0 && item.bat<3.3) battery_value.setBackgroundColor(Color.RED);
            else battery_value.setBackgroundColor(Color.TRANSPARENT);
...
*/
            ...
            version_value.setText("" + item.build);
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            if(item.bat <=3.3 && item.bat>0 || item.mem>90) {
                name.setBackgroundColor(Color.RED);
            } else name.setBackgroundColor(Color.TRANSPARENT);
            ...
            //    s = "LOST";
            if(System.currentTimeMillis() - item.obimon.lastGsrTime <10000) {
                //s = "MEASURING";
